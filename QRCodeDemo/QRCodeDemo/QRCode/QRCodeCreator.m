...
+ (UIImage *)QRCodeImageWithString:(NSString *)string imageSideLength:(CGFloat)sideLength {
    CIImage *qrCodeCI = [[self class] createQRForString:string];
    UIImage *qrCodeUI = [[self class] createNonInterpolatedUIImageFormCIImage:qrCodeCI withSize:sideLength];
    return qrCodeUI;
}
...
+ (UIImage *)QRCodeImageWithString:(NSString *)string imageSideLength:(CGFloat)sideLength red:(CGFloat)red green:(CGFloat)green blue:(CGFloat)blue {
    CIImage *qrCodeCI = [[self class] createQRForString:string];
    UIImage *qrCodeUI = [[self class] createNonInterpolatedUIImageFormCIImage:qrCodeCI withSize:sideLength];
    return [[self class] imageBlackToTransparent:qrCodeUI withRed:red andGreen:green andBlue:blue];
}
